    ...
    <header className="px-8 pt-8 pb-4 text-slate-900 dark:text-eggshell-50">
      <div className="flex w-full items-center border-b border-slate-700/50 pb-4 dark:border-slate-100/50 md:justify-between lg:border-b-0 lg:pb-0">
        <ul className="flex w-full flex-col items-start whitespace-pre text-center sm:w-full md:w-full md:flex-row md:items-center lg:w-6/12">
          ...
          <li className="hidden w-full flex-1 flex-shrink border-l border-r border-slate-700/50 py-4 pl-8 pr-8 dark:border-slate-100/50 xl:block">
            <h2 className="  text-center font-sans text-base font-normal leading-normal">
              Product Designer / Design Technologist
            </h2>
          </li>
          <li className="hidden w-full flex-1 border-r border-slate-700/50 py-6 pl-8 pr-8 dark:border-slate-100/50 xl:block">
            <h2 className="text-center font-sans text-base font-normal leading-normal">
      ...
      <h2 className="block whitespace-pre-line py-6 lg:hidden">
        Product Designer & Design Technologist. <strong>Currently:</strong> Sr. Designer @ USAA
      </h2>
      <Nav />
    </header>
  )
