...
const WorkItem = ({ workPost }) => {
  return (
    <div
      className='flex-col h-48 p-4 bg-center bg-cover rounded cursor-pointer bg-fit md:h-108 hover:scale-105 hover:rounded-l drop-shadow-2xl text-slate-900 dark:text-eggshell-50'
