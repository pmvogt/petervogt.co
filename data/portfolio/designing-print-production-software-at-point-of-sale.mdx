...
<div className="space-evenly mb-8 flex border-y border-slate-900/40 py-4 dark:border-eggshell-50/40">
  <ul className="list-style-none w-3/4">
    <li className="pt-0">**Timeframe**: 2017 - 2019</li>
    <li className="mt-3">**Role**: Experience Designer, Design Technologist</li>
    <li className="mt-3">
      **Skills Leveraged**: Moderated user testing, Contextual inquiries, Heuristic evaluation,
      Sketch, Abstract, FramerJS
    </li>
  </ul>
  <div>
...
- -Team member locates binder "spline options", uploads the customer's artwork to the spline, initiates a "print preview" modal, paginates through or prints all, and reprints the spline page afterward.
