...
excerpt: Since 2019, I've been supporting USAA's insurance line of business as a designer and design technologist.
darkBg: 'https://res.cloudinary.com/dyc1seeg9/image/upload/v1659827308/mesh/mesh-portrait-1.png'
bg: 'https://res.cloudinary.com/dyc1seeg9/image/upload/v1659827345/mesh/mesh-portrait-5.png'
headerBg: 'https://res.cloudinary.com/dyc1seeg9/image/upload/v1659827311/mesh/mesh-landscape-5.png'
headerBgDark: 'https://res.cloudinary.com/dyc1seeg9/image/upload/v1659827350/mesh/mesh-landscape-1.png'
---

<div className="mb-8 grid grid-cols-1 border-y border-slate-900/40 py-4 dark:border-eggshell-50/40 md:grid-cols-2">
  <ul className="list-style-none">
    <li className="pt-0">**Timeframe**: 2019 - Current</li>
    <li className="mt-3">**Role**: Sr. Designer, Design Technologist</li>
    <li>
      **Skills Leveraged**: Moderated research, Journey mapping, Affinity diagramming, Service
      design, React native, React, Vanilla Javascript, SASS, Storybook
    </li>
  </ul>
...
<CustomImage
  publicId="work/usaa/connected-home1.png"
  alt="Design mockups for iOS and Android USAA at Home app"
  width={2426}
  height={1958}
  preview
  mdx
...
iOS platforms on our team, and one of my responsibilties was conducting research with the native designers
and testing the team's conclusions against prototypes I built in React Native. Additionally, I contributed
to shoring up communication barriers between designers and developers and creating a pattern library
for USAA Connected Home extended from the official USAA design system.
...
<CustomImage
  publicId="work/usaa/chboard.png"
  alt="USAA at Home design sprint artifacts"
  width={1008}
  height={756}
  preview
  mdx
...
<CustomImage
  publicId="work/usaa/connected-home2.png"
  alt="USAA at Home design sprint artifacts"
  width={1008}
  height={756}
  preview
...
- -**Multiple policies** - how might we account for members with several homeowner policies?
...
The first React Native prototype I did was a smash hit. We happened to be conceptualizing a Create Account workflow, which was a great baby step into using RN - which I had no experience with prior. The AVP in charge of Connected Home, our executive sponsor, and most importantly to me - our team - were thrilled with the results. I never tire of watching the smiles on a design team when their stuff comes to life.

<CustomImage
  publicId="work/usaa/connected-home-auth.png"
  alt="React native prototype demoing UX for USAA at Home auth"
  width={1300}
  height={786}
  preview
  mdx
...
<CustomImage
  publicId="work/usaa/connected-home3.png"
  alt="Early wires for Connected Home storefront experience"
  width={1032}
  height={758}
  preview
  mdx
...
<CustomImage
  publicId="work/usaa/connected-home5.png"
  alt="USAA Connected Home React prototype I made for our design team"
  width={1374}
  height={4662}
  preview
  mdx
...
In the summer of 2021, I was thrilled to be asked to help the design system developer team in the form
of a residency. The team was going through a top-down overhaul of the entire system, and they were actively
looking for folks to embed and help carry the load.
...
<CustomImage
  publicId="work/usaa/auto-advance-mockup.png"
  alt="USAA Connected Home React prototype I made for our design team"
  width={1024}
  height={1001}
  preview
...
<CustomImage
  publicId="work/usaa/auto-advance-production.gif"
  alt="Screencap of AutoAdvance component in production via Storybook"
  width={632}
  height={416}
  preview
  mdx
