...
headerBg: '/mesh/mesh-landscape-3.png'
headerBgDark: '/mesh/mesh-landscape-7.png'
purgis: 'durgis'
---

<ul className="divide-y-reverse border-t border-b mb-4 w-fit border-slate-500/70 dark:border-eggshell-500/40">
  <li className="py-2">**Timeframe**: 2017-Present</li>
  <li className="py-2">**Role**: Design Technologist</li>
  <li className="py-2">**Company**: projekt202, USAA</li>
</ul>
